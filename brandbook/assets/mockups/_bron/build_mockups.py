...
"""
    # Belettering: logo groot links, telefoon en website rechts. Verder niets.
    white_h = stripe_y - by                        # wit vlak boven de bies
    logo_h = 272
    logo_w = logo_h * logo_ratio("logo")
    clear = 0.107 * logo_w                        # x = deurbreedte, 10,7% van de logobreedte (logo v2)
    lx = bx + 58
...
"""
    write("verhuiswagen.svg", doc(
        ...
        "Zijaanzicht van een witte bakwagen. Op de opbouw het logo, het telefoonnummer "
