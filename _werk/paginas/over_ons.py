...
PAGINA = Pagina(
    ...
    extra_css=("uitsnede", "reviews-schild"), # de gedeelde uitsnede-plaat van "Zo werken wij" en "Kennismaken?"; het 3D-schild op de reviews
    blokken=[
        ("kop", {}),
        ("offertepil", {"variant": "los", "over_kop": True, "kopij": None}),
        ("over-ons", {"kopij_id": "verhaal", "feiten": True, "motto": False}),
        ("kernwaarden", {"kopij_id": "zo-werken-wij", "beeld": ("/img/dienst-particulier-v2-uit.webp", 1080, 810, 231, 178, 619, 583), "compact": "krap"}),
        ("reviews", {}),
